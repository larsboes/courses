...
const layers: DwhLayer[] = [
  ...
  },
  {
    ...
    whatHappens: 'Daten werden in Würfeln organisiert für schnelle multidimensionale Analysen. Fakten aus jeder Ebene einer Dimension werden aggregiert.',
    ...
    characteristics: [
      ...
      'Dimensionen (Produkt, Zeit, Region)',
